  ...
  it('reproduces the Python detected values/keys for every example', async () => {
    ...
    for (const r of (detection as any).records) {
      ...
      const got = {
        ...
        rerolls: d.rerolls, reset_enabled: d.resetEnabled ?? null, charge_enabled: d.chargeEnabled ?? null, current_step: d.currentStep, total_steps: d.totalSteps,
      ...
      const want = {
        ...
        rerolls: e.rerolls, reset_enabled: e.reset_enabled ?? null, charge_enabled: e.charge_enabled ?? null, current_step: e.current_step, total_steps: e.total_steps,
